        ...
        <div className="max-w-[1600px] mx-auto px-6 py-4 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <div className="flex items-center gap-1.5" style={{ borderLeft: `1px solid ${C.border}`, paddingLeft: "0.75rem" }}>
              <a href={process.env.NEXT_PUBLIC_SEO_GEO_LAB_URL ?? "https://seo-geo-6jpsismh2-marc-williame-s-projects.vercel.app/"} target="_blank" rel="noopener noreferrer"
              ...
              {isOwner && (
                <a href={process.env.NEXT_PUBLIC_TICKETING_URL ?? "https://ticketing-ex83ww0ec-marc-williame-s-projects.vercel.app/"} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-1 px-3 py-1.5 text-[8px] font-mono tracking-[0.2em] uppercase hover:opacity-80 transition-opacity"
